...
**Project Overview**
This project performs Exploratory Data Analysis on a retail sales dataset to evaluate sales performance and profitability across different product categories and customer segments.

**Objective**
To analyze historical sales data and identify patterns influencing revenue and profit. The aim is to derive meaningful business insights using data analysis techniques.
...
- Identification of Top Performing and Loss-Making Sub-Categories  
